...
class CatalogoDetalleScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final lcatalogos = ref.watch(catalogDropdownProvider).lregistros;
    final registroSelect = ref.watch(catalogDropdownProvider).registroSelect;
        ...
        body: Column(
          children: [
            DropdownPersonalizado(
              ...
              onchange: ref.watch(catalogDropdownProvider.notifier).onSeleccionChange,
