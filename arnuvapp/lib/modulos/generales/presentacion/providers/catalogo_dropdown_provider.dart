...
final catalogDropdownProvider = StateNotifierProvider.autoDispose<CatalogoDropdownNotifier,CatalogoDropdownState>((ref) {
...
class CatalogoDropdownNotifier extends ArnuvNotifier<CatalogoDropdownState> {
  ...
  }): super( CatalogoDropdownState(lregistros: [catalogoDefault], registroSelect: catalogoDefault ) ){
    listar(1, 1);
  }
  ...
  listar(int limit, int page) async {
    try {
      ...
      lista.insert(0, catalogoDefault);
...
class CatalogoDropdownState extends ArnuvState {
  ...
  @override
  ArnuvState copyWithArnuv({String? errorMessage}) => CatalogoDropdownState(
    lregistros: [catalogoDefault],
    registroSelect: catalogoDefault,
